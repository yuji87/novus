                ...
                <div class="list">
                    ...
                    <div class="text">
                        ...
                        <?php if (isset($question)): ?>
                            ...
                            <?php endif; ?>
                            <!--カテゴリ-->
                            <?php if (isset($question['category_name'])): ?>
                            <div>カテゴリ：<?php echo $question['category_name']; ?></div>
                            <?php endif; ?>
                            <!--本文-->
                            <?php if (isset($question['message'])): ?>
                            <div>本文：<?php echo $question['message']; ?></div>
                            <?php endif; ?>
                            <!--日付-->
                            <?php if (!isset($question['upd_date']) && isset($question['post_date'])): ?>
                            <div>日付：<?php echo $question['post_date']  ?></div>
                            <?php elseif (isset($question['upd_date'])): ?>
                            <div>日付：<?php echo $question['upd_date'] ?></div>
                            <?php endif; ?>
                            <!--名前-->
