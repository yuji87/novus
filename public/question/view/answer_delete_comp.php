    ...
    <section class="wrapper">
        <div class="container">
            <div class="content">
                ...
                <button type="button" class="mb-4 mt-5 btn btn-outline-dark" onclick="location.href='question_disp.php?question_id=<?php echo $_SESSION['a_data']['question_id']  ?>'">質問へ戻る</button>
            </div>
        </div>
    </section>
