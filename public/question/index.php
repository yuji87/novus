	            ...
	            <div class="col-xs-6 col-xs-offset-3">
        		    ...
        		    <?php if (isset($searchQuestion) && count($searchQuestion)): ?>
						...
						<?php foreach ($searchQuestion as $value): ?>
							...
							<div class="block">
								<!--カテゴリ-->
								<div style="background: <?php echo $value['color']; ?>; display: inline-block;" class="artFootLeft badge rounded-pill border border-secondary ml-3"><?php echo htmlspecialchars($value['category_name']); ?></div>
								<!--投稿日時-->
