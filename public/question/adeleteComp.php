    ...
    <section class="wrapper">
        <div class="container">
            <div class="content">
                ...
                <button type="button" class="btn btn-outline-dark fw-bold mb-5" onclick="location.href='qDisp.php?question_id=<?php echo $_SESSION['a_data']['question_id']  ?>'">質問へ戻る</button>
            </div>
        </div>
    </section>
