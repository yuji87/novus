	...
	<header>
	  <nav class="navbar navbar-expand-lg" style="background-color:rgba(55, 55, 55, 0.98);">
		<div class="container-fluid">
			...
			<a href="../login/form.php"><i class="fa-solid fa-arrow-right-to-bracket text-white" style="padding-right:10px;"></i></a>
			<a href="../register/form.php"><i class="fa-solid fa-user-plus text-white"></i></a>
			</span>
		</div>
