...
<body>
    ...
    <header>
        ...
        <ul class="menu">
            <li class="top"><a href="../login/login_top.php">TOPページ</a></li>
            <li><a href="../login/mypage.php">MyPageに戻る</a></li>
            <li><a href="#projects">質問 履歴</a></li>
            <li><a href="#contact">記事 履歴</a></li>
            <li><a href="#contact">お問い合わせ</a></li>
            <li>
                <form type="hidden" action="../login/logout.php" method="POST">
                ...
                <?php endif ?>
                    <div class="list">
                        ...
                        <div class="text-center">
                            <a href="../edit/comment.php" class="p-2 text-white bg-secondary">再入力する</a>
                        </div>
                        <?php else :?>
                        <div class="text-center">
                            <a href="../edit/comment.php" class="p-2 text-white bg-secondary">戻る</a>
