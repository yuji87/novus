...
class Action 
{
  ...
  function printHeader() {
    ...
    echo '<body>';
    echo '<header>';
    echo '<div class="navtext-container">';
    echo '<div class="navtext">novus</div>';
    echo '</div>';
    if(isset($_SESSION["login_user"])):
    echo '<input type="checkbox" class="menu-btn" id="menu-btn">';
    echo '<label for="menu-btn" class="menu-icon"><span class="navicon"></span></label>';
    echo '<ul class="menu">';
    echo '<li class="top"><a href="../userLogin/home.php">TOPページ</a></li>';
    echo '<li><a href="' . DOMAIN . '/public/userLogin/mypage.php">マイページ</a></li>';
    echo '<li><a href="' . DOMAIN . '/public/todo/index.php">TO DO LIST</a></li>';
    echo '<li><a href="' . DOMAIN . '/public/question/qHistory.php">質問 履歴</a></li>';
    echo '<li><a href="' . DOMAIN . '/public/">記事 履歴</a></li>';
    echo '<li>';
    echo '<form type="hidden" action="' . DOMAIN . '/public/userLogin/logout.php" method="POST">';
    echo '<input type="submit" name="logout" value="ログアウト" id="logout" style="text-align:left;">';
    echo '</form>';
    echo '</li>';
    echo '</ul>';
    else:
    ...
    echo '<label for="menu-btn" class="menu-icon"><span class="navicon"></span></label>';
    echo '<ul class="menu">';
    echo '<li class="top"><a href="' . DOMAIN . '/public/user/top.php">TOPページ</a></li>';
    echo '<li><a href="' . DOMAIN . '/public/question/qHistory.php">記事ページ</a></li>';
    echo '</ul>';
    endif;
    echo '</header>';
