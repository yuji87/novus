            ...
            <div class="content">
                ...
                <?php endif ?>
                    <div class="list">
                        <!--ユーザーが登録した名前を表示-->
                        <div class="text">
                            <label for="name" style="float:center; padding-left:120px; padding-bottom:10px;">[Name]</label>
                            <span name="name" class="check-info" style=><?php echo htmlspecialchars($_SESSION['nameEdit'], ENT_QUOTES, 'UTF-8'); ?></span>
                            <!--未記入時のエラーメッセージ表示-->
