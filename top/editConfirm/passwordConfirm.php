    ...
    <section class="wrapper">
        ...
        <?php endif ?>
                    <div class="list">
                        <!--ユーザーが登録した名前を表示-->
                        <div class="text">
                        <label for="name" style="float:center; padding-left:120px; padding-bottom:10px;">[Password]</label>
                            <span name="password" class="check-info"><?php echo htmlspecialchars($_SESSION['passwordEdit'], ENT_QUOTES, 'UTF-8'); ?></span>
                        </div>
                        <br><br>
                        <!--未記入時のエラーメッセージ表示-->
                        ...
                        <div class="col-4 bg-secondary">
                            <a href="../userEdit/passwordEdit.php" class="back-btn text-white">再入力する</a>
                        </div>
                        <?php else :?>
                        <div class="col-4 bg-secondary">
