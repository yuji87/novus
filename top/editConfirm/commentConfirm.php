            ...
            <div class="content">
                ...
                <?php endif ?>
                    <div class="list">
                        <!--ユーザーが登録した名前を表示-->
                        <div class="text">
                        <label for="name" style="float:center; padding-left:120px; padding-bottom:10px;">[Comment]</label>
                            <span name="comment" class="check-info"><?php echo htmlspecialchars($_SESSION['commentEdit'], ENT_QUOTES, 'UTF-8'); ?></span>
                        </div>
                        <br><br>
                        <!--未記入時のエラーメッセージ表示-->
